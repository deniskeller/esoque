...
import styles from "./BaseSearchSelectApp.module.scss";
...
const BaseSearchSelectApp: React.FC<Props> = ({
  placeholder,
  style,
  className,
  type = "default",
  ...
  return (
    <div
      className={`${styles.SelectContainer} ${styles["Select_" + type]} ${className} ${
        styles["SelectSearch_" + inputSize]
      }`}
...
export default BaseSearchSelectApp;
